...
GRANT SELECT, INSERT, UPDATE, DELETE, REFERENCES, TRIGGER ON TABLE products TO "productsUser";

ALTER TABLE public.productavailability OWNER TO "productsUser";
GRANT SELECT, INSERT, UPDATE, DELETE, REFERENCES, TRIGGER ON TABLE productavailability TO "productsUser";

ALTER SEQUENCE public.products_seq OWNER TO "productsUser";
GRANT USAGE, SELECT ON SEQUENCE products_seq TO "productsUser";
